  ...
  <div class="hr-list">
    <div class="hr-content">
      ...
      <el-dialog
        ...
        title="temp"
      >
        <span> <Strong>Cập nhật số tiền hỗ trợ</Strong></span>
        <div class="row">
              ...
              <div class="col-6">
                <div>
                  <div class="mb-3">
                    <label class="form-label"
                      ><Strong
                        >Ngày sinh <span style="color: red">(*)</span>:</Strong
                      ></label
                    >
                    <input
                      v-model="staff.date"
      ...
      >
        ...
        <div label-width="120px" class="pl-table__content">
          <h6>
            ...
            <strong>{{ formatCurrency(staff.welfareMoney) }}</strong> / Số tiền
            đang sử dụng: <strong>{{ formatCurrency(Money1 + Money2) }}</strong>
...
export default {
  ...
  methods: {
    ...
    validateName() {
      var re = /^[A-Za-z]+$/;
      if (re.test(document.getElementById("textboxID").value)) alert("ddungs!");
      else alert("sai.");
    },
  },
  mounted() {
